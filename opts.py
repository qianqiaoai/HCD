...
def get_args_parser():
    ...
    parser.add_argument('--ytvos_path', type=str, default='/mnt/data/user/zhangruixin/dataset/ref-youtube')
    ...
    parser.add_argument('--resume_path', default='checkpoints/checkpoint.pth', help='resume path')
    parser.add_argument('--checkpoint_path', default='checkpoints/checkpoint.pth', help='checkpoint path')
