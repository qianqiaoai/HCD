...
class BackboneBase(nn.Module):
    ...
    def forward(self, tensor_list: NestedTensor, num_frames: int, captions: str):
        ...
        xs1, encoder_hidden_states_c = self.diff_ftex(batch)
        xs = {}
        ...
        return out, encoder_hidden_states_c
...
class Joiner(nn.Sequential):
    ...
    def forward(self, tensor_list: NestedTensor, captions: str):
        ...
        xs, encoder_hidden_states_c = self[0](tensor_list, num_frames=t, captions=captions)
        ...
        return out, pos, encoder_hidden_states_c
...
if __name__ == '__main__':
    ...
    model = VideoSwinTransformerBackbone(True, 'video_swin_pretrained/swin_tiny_patch244_window877_kinetics400_1k.pth',
                                         True, **cfgs).cuda()
